...
namespace ScampusCloud.Repository.VisitorReason
{
    public class VisitorReasonRepository
    {
		...
		public List<VisitorReasonModel> GetVisitorReasonList(string searchtxt = "", int page = 1, int pagesize = 10)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetVisitorReasonData_Export(string searchtxt = "")
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
