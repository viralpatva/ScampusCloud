...
namespace ScampusCloud.Repository.CardStatus
{
    public class CardStatusRepository
    {
		...
		public List<CardStatusModel> GetCardStatusList(string searchtxt = "", int page = 1, int pagesize = 10, string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetCardStatusData_Export(string searchtxt = "", string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
