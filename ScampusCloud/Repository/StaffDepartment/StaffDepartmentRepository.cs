...
namespace ScampusCloud.Repository.StaffDepartment
{
	public class StaffDepartmentRepository
	{
		...
		public List<StaffDepartmentModel> GetStaffDepartmentList(string searchtxt = "", int page = 1, int pagesize = 10, string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetStaffDepartmentData_Export(string searchtxt = "", string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
