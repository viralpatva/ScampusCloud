...
namespace ScampusCloud.Repository.DegreeType
{
	public class DegreeTypeRepository
	{
		...
		public List<DegreeTypeModel> GetDegreeTypeList(string searchtxt = "", int page = 1, int pagesize = 10, string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetDegreeTypeData_Export(string searchtxt = "", string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
