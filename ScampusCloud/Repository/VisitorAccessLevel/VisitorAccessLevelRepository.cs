...
namespace ScampusCloud.Repository.VisitorAccessLevel
{
	public class VisitorAccessLevelRepository
	{
		...
		public List<VisitorAccessLevelModel> GetVisitorAccessLevelList(string searchtxt = "", int page = 1, int pagesize = 10, string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetVisitorAccessLevelData_Export(string searchtxt = "", string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
