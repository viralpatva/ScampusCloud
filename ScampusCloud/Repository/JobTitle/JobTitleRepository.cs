...
namespace ScampusCloud.Repository.JobTitle
{
    public class JobTitleRepository
    {
		...
		public List<JobTitleModel> GetJobTitleList(string searchtxt = "", int page = 1, int pagesize = 10, string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
		...
		public DataTable GetJobTitleData_Export(string searchtxt = "", string CompanyId = null)
		{
			try
			{
				QueryBuilder objQueryBuilder = new QueryBuilder
