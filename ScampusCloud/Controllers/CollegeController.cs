...
namespace ScampusCloud.Controllers
{
    ...
    public class CollegeController : Controller
    {
        ...
        public ActionResult College()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_CollegeRepository.GetAllCount(searchtxt));
        ...
        public ActionResult CollegeList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_CollegeRepository.GetAllCount(searchtxt));
                var lstCountries = _CollegeRepository.GetCollegeList(searchtxt, page, pagesize);
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _CollegeRepository.GetCollegeData_Export(searchtxt);
