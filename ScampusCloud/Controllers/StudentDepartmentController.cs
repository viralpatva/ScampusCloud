...
namespace ScampusCloud.Controllers
{
    ...
    public class StudentDepartmentController : Controller
    {
        ...
        public ActionResult StudentDepartment()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_StudentDepartmentRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult StudentDepartmentList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_StudentDepartmentRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _StudentDepartmentRepository.GetStudentDepartmentList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _StudentDepartmentRepository.GetStudentDepartmentData_Export(searchtxt, SessionManager.CompanyId.ToString());
