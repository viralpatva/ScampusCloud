...
namespace ScampusCloud.Controllers
{
    public class VisitorReasonController : Controller
    {
        ...
        public ActionResult VisitorReason()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_VisitorReasonRepository.GetAllCount(searchtxt));
        ...
        public ActionResult AddEditVisitorReason(string ID = "")
        {
            try
            {
                ...
                _VisitorReasonModel.CreatedBy = new Guid(Session["UserId"].ToString());
                _VisitorReasonModel.ModifiedBy = new Guid(Session["UserId"].ToString());
                _VisitorReasonModel.CompanyId = new Guid(Session["CompanyId"].ToString());
        ...
        public ActionResult VisitorReasonList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_VisitorReasonRepository.GetAllCount(searchtxt));
                var lstCountries = _VisitorReasonRepository.GetVisitorReasonList(searchtxt, page, pagesize);
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _VisitorReasonRepository.GetVisitorReasonData_Export(searchtxt);
