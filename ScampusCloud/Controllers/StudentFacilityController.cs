...
namespace ScampusCloud.Controllers
{
    ...
    public class StudentFacilityController : Controller
    {
        ...
        public ActionResult StudentFacility()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_StudentFacilityRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult StudentFacilityList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_StudentFacilityRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _StudentFacilityRepository.GetStudentFacilityList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _StudentFacilityRepository.GetStudentFacilityData_Export(searchtxt, SessionManager.CompanyId.ToString());
