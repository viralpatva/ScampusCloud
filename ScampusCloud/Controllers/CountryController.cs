...
namespace ScampusCloud.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public ActionResult Country()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_CountryRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult AddEditCountry(string ID = "")
        {
            try
            {
                ...
                _CountryModel.CreatedBy = SessionManager.UserId;
                _CountryModel.ModifiedBy = SessionManager.UserId;
                _CountryModel.CompanyId = SessionManager.CompanyId;
                ...
                if (!string.IsNullOrEmpty(ID) && ID != "0")
                {
                    ...
                    if (_CountryModel != null)
                    {
                        ...
                        SessionManager.Code = _CountryModel.Code;   
                    }
                    else
                    {
        ...
        public ActionResult CountryList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_CountryRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _CountryRepository.GetCountryList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _CountryRepository.GetCountryData_Export(searchtxt, SessionManager.CompanyId.ToString());
