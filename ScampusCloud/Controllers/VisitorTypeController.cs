...
namespace ScampusCloud.Controllers
{
    ...
    public class VisitorTypeController : Controller
    {
        ...
        public ActionResult VisitorType()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_VisitorTypeRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(ID) && ID != "0")
                {
                    ...
                    if (_VisitorTypeModel != null)
                    {
                        ...
                        SessionManager.Code = _VisitorTypeModel.Code;
                    }
                    else
                    {
        ...
        public ActionResult VisitorTypeList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_VisitorTypeRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _VisitorTypeRepository.GetVisitorTypeList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _VisitorTypeRepository.GetVisitorTypeData_Export(searchtxt, SessionManager.CompanyId.ToString());
