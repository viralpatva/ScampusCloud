...
namespace ScampusCloud.Controllers
{
    ...
    public class ProgramController : Controller
    {
        ...
        public ActionResult Program()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_ProgramRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult AddEditProgram(string ID = "")
        {
            try
            {
                ...
                _ProgramModel.CreatedBy = SessionManager.UserId;
                _ProgramModel.ModifiedBy = SessionManager.UserId;
                _ProgramModel.CompanyId = SessionManager.CompanyId;
        ...
        public ActionResult ProgramList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_ProgramRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _ProgramRepository.GetProgramList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _ProgramRepository.GetProgramData_Export(searchtxt, SessionManager.CompanyId.ToString());
