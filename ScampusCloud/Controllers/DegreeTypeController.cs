...
namespace ScampusCloud.Controllers
{
    ...
    public class DegreeTypeController : Controller
    {
        ...
        public ActionResult DegreeType()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_DegreeTypeRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult DegreeTypeList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_DegreeTypeRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _DegreeTypeRepository.GetDegreeTypeList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _DegreeTypeRepository.GetDegreeTypeData_Export(searchtxt, SessionManager.CompanyId.ToString());
