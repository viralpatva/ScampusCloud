...
namespace ScampusCloud.Controllers
{
    ...
    public class CardStatusController : Controller
    {
        ...
        public ActionResult CardStatus()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_CardStatusRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
        ...
        public ActionResult CardStatusList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_CardStatusRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _CardStatusRepository.GetCardStatusList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _CardStatusRepository.GetCardStatusData_Export(searchtxt, SessionManager.CompanyId.ToString());
