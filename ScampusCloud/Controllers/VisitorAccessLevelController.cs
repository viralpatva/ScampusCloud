...
namespace ScampusCloud.Controllers
{
    ...
    public class VisitorAccessLevelController : Controller
    {
        ...
        public ActionResult VisitorAccessLevel()
        {
            ...
            string searchtxt = "NA";
            int totals = Convert.ToInt32(_VisitorAccessLevelRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(ID) && ID != "0")
                {
                    ...
                    if (_VisitorAccessLevelModel != null)
                    {
                        ...
                        SessionManager.Code = _VisitorAccessLevelModel.Code;
                    }
                    else
                    {
        ...
        public ActionResult VisitorAccessLevelList(int page = 1, int pagesize = 10, string searchtxt = "")
        {
            try
            {
                ...
                int totals = Convert.ToInt32(_VisitorAccessLevelRepository.GetAllCount(searchtxt, SessionManager.CompanyId.ToString()));
                var lstCountries = _VisitorAccessLevelRepository.GetVisitorAccessLevelList(searchtxt, page, pagesize, SessionManager.CompanyId.ToString());
        ...
        public FileResult Export(string searchtxt = "")
        {
            ...
            try
            {
                dt = _VisitorAccessLevelRepository.GetVisitorAccessLevelData_Export(searchtxt, SessionManager.CompanyId.ToString());
