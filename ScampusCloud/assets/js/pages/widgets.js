...
var KTWidgets = function () {
    ...
    var _initDaterangepicker = function () {
        ...
        function ModifiedStartDate() {
            var startdate = moment();
            if ($("#ConstFromDate").val() != undefined && $("#ConstFromDate").val().length > 0) {
                startdate = moment($("#ConstFromDate").val());
            }
            return startdate;
        }

        function ModifiedEndDate() {
            var enddate = moment();
            if ($("#ConstToDate").val() != undefined && $("#ConstToDate").val().length > 0) {
                enddate = moment($("#ConstToDate").val());
            }
            return enddate;
        }


        var start = ModifiedStartDate();
        var end = ModifiedEndDate();
        ...
        function cb(start, end, label) {
            ...
            $('#kt_dashboard_daterangepicker_date').html(start.format('MM/DD/YYYY') + ' - ' + end.format('MM/DD/YYYY'));
        ...
        picker.daterangepicker({
            ...
            ranges: {
                'Today': [ModifiedStartDate(), ModifiedEndDate()],
                'Yesterday': [ModifiedStartDate().subtract(1, 'days'), ModifiedEndDate().subtract(1, 'days')],
                //'Today': [moment(), moment()],
    ...
    //// custom widgets
    var _iniTaxedSales = function (_series, _label) {
        var element = document.getElementById("kt_taxed_sales_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var initnontaxedsales = function (_series, _label) {
        var element = document.getElementById("kt_non_taxed_sales_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var inittaxexemptsales = function (_series, _label) {
        var element = document.getElementById("kt_tax_exempt_sales_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    return {
        ...
        //custom widgets
        TaxedSales: function (_series, _label) {
            _iniTaxedSales(_series, _label);
        },
        NonTaxedSales: function (_series, _label) {
            initnontaxedsales(_series, _label);
        },
        TaxExemptSales: function (_series, _label) {
            inittaxexemptsales(_series, _label);
        }
    }
}();
