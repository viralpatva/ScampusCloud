;(function( $, window, document, undefined ) {
  ...
  $.qrCodeReader = {
    jsQRpath: "../assets/js/QRCode/jsQR/jsQR.min.js",
    jsQRpath: "../assets/js/QRCode/jsQR/jsQR.js",
     beepPath: "../assets/js/QRCode/audio/beep.mp3",
    instance: null,
    defaults: {
  ...
  QRCodeReader.prototype = {
    ...
    buildHTML: function() {
     ...
     /* qrr.audio = $('<audio hidden id="qrr-beep" src="' + $.qrCodeReader.beepPath + '" type="audio/mp3"></audio>');*/
      ...
      qrr.outputDiv = $('<div id="qrr-output" style="display: none;"></div>');
